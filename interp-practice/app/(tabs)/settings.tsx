            ...
            <View style={styles.modalBox}>
              ...
              <View style={styles.columnGuide}>
                ...
                {([
                  ...
                  { name: "modelKorean",   desc: "영→한 연습 3단계 비교에서 원문 아래 표시. 비워두면 koreanText가 대신 표시.", required: false },
                  { name: "modelEnglish",  desc: "한→영 연습 3단계 비교에서 원문 아래 표시. 비워두면 englishText가 대신 표시.", required: false },
